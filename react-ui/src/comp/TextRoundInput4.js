...
import '../css/TextRoundInput4.css';
import logo from '../css/Images/QALELOGO.png';

export default withAuth(class TextRoundInput4 extends Component {
  constructor( props ) {
    super( props );
    this.state = {
      text: " ",
  ...
  handleSubmit(event) {
    ...
    this.props.auth._history.push("/textroundinput5")
  }
